    ...
    <footer className="bg-light-surface dark:bg-dark-surface border-t border-light-border dark:border-dark-border">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
              📊 Building ML models. 🔐 Testing for security. 🚀 Creating reliable systems. ✨
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-semibold text-light-text dark:text-dark-text mb-4">
              🔗 Quick Links
            </h4>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/projects"
                  className="text-sm text-light-text-secondary dark:text-dark-text-secondary hover:text-accent transition-colors"
                >
                  🚀 Projects
                </Link>
              </li>
        ...
        <div className="mt-8 pt-8 border-t border-light-border dark:border-dark-border text-center">
          <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
            © {currentYear} Enatan Dereje. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
